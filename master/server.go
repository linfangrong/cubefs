...
const (
	...
	cfgHttpReadTimeout       = "httpReadTimeout"
	cfgHttpReadHeaderTimeout = "httpReadHeaderTimeout"
	cfgHttpWriteTimeout      = "httpWriteTimeout"
	cfgHttpIdleTimeout       = "httpIdleTimeout"
)
